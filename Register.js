...
onSubmitSignin = () => {
    ...
    fetch('http://localhost:3005/register_customer', {
        method: 'post',
    ...
    // .catch((err)=>{alert("Invalid or duplicate data"+err)});
    // .catch(err=> response.status(400).json("Invalid or duplicate details"));
    }
    render()
    {
                    ...
                    <div className="pa4 black-80">
                        <div className="measure center">
                            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                                <legend className="f4 fw6 ph0 mh0">Register as Customer</legend>
                                <div className="mt3">
